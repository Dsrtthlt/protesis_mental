...
La selección de los pasajes y temas está orientada por la búsqueda de un hilo conductor específico: las división entre grandes campos de conocimiento se ha transformado así como los 'objetos' que estudia: los textos agrupados en el libro dan cuenta de una 'normalización' de esos cambios.

Lo importante de esta selección es precisar los aspectos que han cambiado así como las causas de ello en el quehacer de  las ciencias que se relacionen con los temas abordados en las contribuciones que dan forma al libro 
```
...
```
Este tema está presente en el trabajo sobre la barbacóa con respecto a la finitud de los bienes y el daño ecológico
```

- EL estado y la universidad. 

```
Múltiples de los artículos abordan el papel del estado en la solución de problemas, Identificar cuales
```
